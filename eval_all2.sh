...
RESNET_MODELS_LONG=("densenet_121" "convnext_base_bnu" "convnext_base_pn")
...
#     echo "Evaluating model: $model"
#     # Run the evaluation and redirect output to a corresponding text file
#     IMAGENET_PATH="../imagenet_validation/" python -m interpretability.analyses.localisation --reload best_any --analysis_config 500_2x2 --explainer_name Ours --smooth 15 --batch_size 64 --save_path "./bcos/experiments/ImageNet/vit_final/${model}/" > "results/localisation/${model}.txt"
# done
