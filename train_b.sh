...
for value in "${BCOS[@]}"; do
    ...
    EXPLAIN="true" DATA_ROOT="../cifar10/" B_PARAMETER="$value" MAXOUT_PARAMETER="2" python evaluate.py --dataset CIFAR10 --experiment_name resnet_20 --base_network norm_ablations_final --reload last
